...
reported to the maintainers via a private channel (e.g. a maintainer's contact
listed in the repository, or a security-style private report if no other
channel is available — see `SECURITY.md` for the reporting mechanism this
project already provides). All complaints will be reviewed and investigated
promptly and fairly.
